...
const MARKET_PRODUCTS: Record<string, { cost: number; hourlyRate: number; adsRequired: number }> = {
  tiny:   { cost: 16700, hourlyRate: 125, adsRequired: 1 },
  river:  { cost: 24500, hourlyRate: 150, adsRequired: 2 },
  gold:   { cost: 30100, hourlyRate: 185, adsRequired: 2 },
  royal:  { cost: 35600, hourlyRate: 215, adsRequired: 3 },
  commit: { cost: 40500, hourlyRate: 250, adsRequired: 3 },
};
