...
const en = {
  ...
  ref: {
    headline: "Earn +1500 $MANGO per referral — receive a lifetime 10% commission on everything your friend earns.",
    rule: "Each invite +300 🥭. When your invitee watches 3 ads in Tasks → Ads, you get +700 🥭 more. Plus lifetime 10% commission.",
    progress: "{{done}}/3 ads",
    ...
    shareMsg: "Join me on MangoCash and earn a lifetime 15% commission on everything your friends earn.",
  },
  profile: {
...
const tr = {
  ...
  ref: {
    headline: "Her davet için +1500 $MANGO — arkadaşının tüm kazancından ömür boyu %10 komisyon.",
    rule: "Her davette +300 🥭. Davet ettiğin Task → Ads kısmında 3 reklam izlerse +700 🥭 daha alırsın. Ayrıca ömür boyu %10 komisyon.",
