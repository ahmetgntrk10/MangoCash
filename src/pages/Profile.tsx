...
import {
  ...
  Globe, ChevronRight, MapPin, Loader2, BellRing, Trophy, Crown,
} from "lucide-react";
...
type Sheet = null | "address" | "convert" | "withdraw" | "history" | "promo" | "lang" | "leaderboard";
  ...
  return (
    <div className="space-y-5">
      ...
      <Section label={t("profile.community")}>
        <Row icon={Trophy} label="Leaderboard" onClick={() => setSheet("leaderboard")} />
